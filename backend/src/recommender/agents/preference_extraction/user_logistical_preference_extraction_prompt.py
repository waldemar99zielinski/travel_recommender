...
user_logistical_preference_extraction_prompt_template = ChatPromptTemplate.from_messages(
    [
        (
            ...
            - For popularity, capture whether the user prefers popular places or wants to avoid crowds, ranged from 0 to 5
              where 0 = user does not like crowds and prefers less known location, 5 = user prefers popular places and does not mind crowds.
